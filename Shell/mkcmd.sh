...
function check_env()
{
	...
	# 测试时加的注释
	# echo "LICHEE_CHIP is ${LICHEE_CHIP}"
	# echo "LICHEE_PLATFORM is ${LICHEE_PLATFORM}"
	# echo "LICHEE_KERN_VER is ${LICHEE_KERN_VER}"
	# echo "LICHEE_ARCH is ${LICHEE_ARCH}"
	# echo "LICHEE_BOARD is ${LICHEE_BOARD}"
}
